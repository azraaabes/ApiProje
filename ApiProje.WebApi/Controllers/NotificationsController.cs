...
namespace ApiProje.WebApi.Controllers
{
    ...
    {
        private readonly IMapper _mapper; //Burada mapleme işlemi uygulayacağız
        ...
        {
            var value = _mapper.Map<Notification>(createNotificationDto); //Notification sınıfını parametreden gelen değerle mapliyoruz 
